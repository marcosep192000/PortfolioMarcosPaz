...
public class MainSecurity extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        http.cors().and().csrf().disable()
                ...
                //---------------------------------------------------------//
                .antMatchers(HttpMethod.POST,"/education/update").permitAll()
                ...
                .antMatchers(HttpMethod.POST,"/education/delete").permitAll()
                .antMatchers(HttpMethod.POST,"/education/**").permitAll()
                //---------------------------------------------------------//
                .antMatchers(HttpMethod.POST,"/experience/update").permitAll()
                ...
                .antMatchers(HttpMethod.POST,"/experience/delete").permitAll()
                .antMatchers(HttpMethod.POST,"/experience/**").permitAll()
                //---------------------------------------------------------//
                .antMatchers("/project/**").permitAll()
                .antMatchers(HttpMethod.POST,"/project/update").permitAll()
                ...
                .antMatchers(HttpMethod.POST,"/project/delete").permitAll()
                //---------------------------------------------------------//
                .antMatchers("/project/**").permitAll()
                .antMatchers(HttpMethod.POST,"/skills/update").permitAll()
                ...
                .antMatchers(HttpMethod.POST,"/skills/delete").permitAll()
